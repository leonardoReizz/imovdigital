...
- apps/api/src/modules/site-config/site-config.controller.ts
- apps/api/src/modules/site-config/site-config.dto.ts
- apps/api/src/modules/site-config/site-config.module.ts
- apps/api/src/modules/site-config/site-config.service.ts
...
`@nestjs/common`, `@nestjs/config`, `@nestjs/throttler`, `@nestjs/jwt`, `@nestjs/passport`, `resend`, `bcryptjs`, `@imovdigital/utils`, `passport-jwt`, `@anthropic-ai/sdk`, `express`, `class-validator`, `class-transformer`, `@imovdigital/types`, `crypto`, `stripe`, `dns`, `@aws-sdk/client-s3`, `@aws-sdk/s3-request-presigner`, `stream`
