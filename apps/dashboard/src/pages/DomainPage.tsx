              ...
              <div className={`flex gap-4 ${!hasDomain ? 'opacity-40 pointer-events-none' : ''}`}>
                ...
                <div className="flex-1 pb-6">
                  ...
                  <div className="bg-gray-50 rounded-xl border border-gray-100 p-4 space-y-3">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-semibold text-gray-400 uppercase w-20 shrink-0">Tipo</span>
                      <span className="inline-block bg-blue-100 text-blue-700 text-xs font-bold px-2 py-0.5 rounded">CNAME</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-semibold text-gray-400 uppercase w-20 shrink-0">Nome</span>
                      <span className="font-mono text-xs text-gray-700">{tenant?.customDomain?.startsWith('www.') ? 'www' : '@'}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-semibold text-gray-400 uppercase w-20 shrink-0">Valor</span>
                      <span className="font-mono text-xs text-gray-900 font-semibold break-all">{originDomain}</span>
                      <button
