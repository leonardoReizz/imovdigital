...
function RealPropertyCard({ property, showPrice, showBadge, primaryColor, onClick }: {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden cursor-pointer hover:shadow-lg hover:border-gray-200 transition-all" onClick={onClick}>
